...
{
    public partial class frm_OdatTankhahAzKarshenasan : Form
    {
        public frm_OdatTankhahAzKarshenasan()
        {
            InitializeComponent();
        }

        private void Frm_OdatTankhahAzKarshenasan_Load(object sender, EventArgs e)
        {
        ...
        private void btnSabt_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Fund fund = new Fund();
                fund.sabtDaryafit(Convert.ToInt64(textBoxResult) * -1, lblTitle.Text, tozi, fund.pcCode(comEmp.SelectedItem.ToString()));
